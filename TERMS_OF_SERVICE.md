...
Welcome to Consigliary! These Terms of Service ("Terms") govern your access to and use of the Consigliary mobile application and related services (collectively, the "Service") provided by HTDSTUDIO AB ("Company," "we," "us," or "our").
...
- Third-party payment processors (Stripe, etc.)

Payment terms are subject to the processor's terms and conditions.
...
- Through App Store subscription settings
...
### **6.1 Your Content**
You retain ownership of all content you upload, create, or share through the Service ("User Content"), including:
...
### **6.2 License to Us**
By uploading User Content, you grant us a limited, non-exclusive, worldwide license to:
...
- Share your content with third parties (except as required to provide services)
...
- Consequences of sharing your content
...
### **6.5 Content Removal**
We reserve the right to remove User Content that:
...
## 7. AI and Automated Services

### **7.1 AI Analysis**
Our Service uses artificial intelligence to analyze contracts and generate insights. You acknowledge that:
- AI analysis may contain errors or inaccuracies
- Results are for informational purposes only
- AI does not replace professional legal advice
- You should verify all AI-generated content

### **7.2 No Legal Advice**
**IMPORTANT**: The Service does NOT provide legal advice. All analysis, recommendations, and generated documents are for informational purposes only. You should:
- Consult qualified attorneys for legal matters
- Verify all information independently
- Not rely solely on AI analysis for important decisions
...
- Analyze your own contracts and documents
- Create split sheets for your collaborations
- Generate license agreements for your music
- Track your revenue and activity
...
### **8.3 Enforcement**
We may investigate violations and take action, including:
- Warning users
...
### **9.1 Our Property**
The Service and all related content, features, and functionality are owned by HTDSTUDIO AB and protected by:
- Copyright
- Trademark
- Patent
- Trade secret laws
...
### **9.2 Limited License**
We grant you a limited, non-exclusive, non-transferable license to use the Service for your personal or business purposes, subject to these Terms.
...
We may integrate with third-party services (e.g., cloud storage, payment processors). You are responsible for complying with their terms.
...
By using the Service, you consent to our Privacy Policy and agree to its terms.
...
### **12.3 Use at Your Own Risk**
You use the Service at your own risk. We are not responsible for:
- Decisions made based on Service content
- Losses resulting from Service use
...
These limitations reflect the allocation of risk between us and are fundamental to our agreement.

---

## 14. Indemnification

You agree to indemnify, defend, and hold harmless HTDSTUDIO AB and its officers, directors, employees, agents, and affiliates from any claims, damages, losses, liabilities, and expenses (including attorney fees) arising from:
...
- Modify or discontinue the Service (or any part)
...
### **17.5 Venue**
If arbitration does not apply, disputes shall be resolved in courts located in [Your State/Country].
...
These Terms, together with our Privacy Policy and EULA, constitute the entire agreement between you and HTDSTUDIO AB.
...
BY USING CONSIGLIARY, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS, UNDERSTAND THEM, AND AGREE TO BE BOUND BY THEM.

---

**Consigliary** - Empowering Music Professionals

© 2024 HTDSTUDIO AB. All rights reserved.
