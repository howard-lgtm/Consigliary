...
This End User License Agreement ("Agreement") is a legal agreement between you ("User," "you," or "your") and HTDSTUDIO AB ("Company," "we," "us," or "our") for the use of the Consigliary mobile application ("App").
...
- Use the App for your personal or business purposes
...
### **2.1 Our Property**
The App and all related content, features, and functionality are owned by HTDSTUDIO AB and are protected by:
- Copyright laws
- Trademark laws
- Patent laws
- Trade secret laws
...
- Contracts you analyze
- Split sheets you create
- Data you input
...
- Paid subscription plans with enhanced features
- One-time purchases for specific services

### **4.2 Payment Terms**
- Fees are charged in advance on a recurring basis (monthly/annual)
- Payment is processed through Apple App Store or other authorized providers
...
- Require valid payment information
- Are limited to one per user

### **4.4 Cancellation**
You may cancel your subscription at any time:
- Through the App Store subscription settings
...
- Analyze music industry contracts
- Generate split sheets and agreements
...
### **6.2 AI Limitations**
**IMPORTANT**: AI analysis is provided for informational purposes only and:
- Is NOT legal advice
...
- Decisions made based on AI analysis
- Verifying AI-generated content
- Consulting with attorneys for legal matters
...
### **7.1 No Legal Advice**
**THE APP DOES NOT PROVIDE LEGAL ADVICE.** All content, analysis, and recommendations are for informational purposes only. Consult a qualified attorney for legal matters.

### **7.2 "As Is" Basis**
THE APP IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, INCLUDING:
...
### **7.4 Exceptions**
Some jurisdictions do not allow limitations on warranties or liability. In such cases, our liability is limited to the extent permitted by law.

---

## 8. Indemnification

You agree to indemnify and hold harmless HTDSTUDIO AB and its officers, directors, employees, and agents from any claims, damages, losses, or expenses (including attorney fees) arising from:
- Your use of the App
...
Your use of the App is also governed by our Privacy Policy, which is incorporated into this Agreement by reference. Please review our Privacy Policy to understand how we collect, use, and protect your information.
...
- Damages from third-party interactions

### **10.2 Third-Party Terms**
Your use of third-party services (e.g., Apple App Store, payment processors) is subject to their own terms and conditions.
...
You may need to update the App to continue using it.

### **11.2 Agreement Changes**
We may modify this Agreement at any time. We will notify you of material changes by:
- Posting the updated Agreement in the App
- Sending an email notification
- Displaying a prominent notice

Your continued use after changes constitutes acceptance of the updated Agreement.
...
### **13.4 Exceptions**
Some jurisdictions do not allow arbitration agreements. In such cases, disputes shall be resolved in courts located in [Your State/Country].
...
This Agreement, together with our Privacy Policy, constitutes the entire agreement between you and HTD Studio, LLC regarding the App.
...
### **14.5 Assignment**
You may not assign this Agreement. We may assign our rights and obligations without notice.
...
BY USING CONSIGLIARY, YOU ACKNOWLEDGE THAT YOU HAVE READ THIS AGREEMENT, UNDERSTAND IT, AND AGREE TO BE BOUND BY ITS TERMS.
